...
<nav className="navbar navbar-expand-lg  header-design">
  <div className="container-fluid mainheader">
    <a className="navbar-brand text-light" href="#"><img src={logo} alt="" className='header-logo'/>
</a>
    ...
    <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <Link className="nav-link active me-auto mb-2 mb-lg-0 text-light" aria-current="page" to="/about"><b>About US</b></Link>
        </li>
        ...
        <li class="nav-item dropdown ">
          ...
          <Link class="dropdown-item" aria-current="page" to="/"> <b>Department Of Pediatrics</b></Link>
      ...
      <form className="d-flex" role="search">
        ...
        <Link className="nav-link active me-auto mb-1 mb-lg-0  button-header" aria-current="page" to="/contact"><b>Contact Us</b></Link>
